...
system('hdfs dfs -rm -r hdfs://master:9000/DB_42_seq_suk');


dsx = fileDatastore('hdfs://master:9000/DB_42_mat_suk/', 'ReadFcn', @load);
ds2 = mapreduce(dsx, @my_mapper, @iReducer, 'OutputFolder', 'hdfs://master:9000/DB_42_seq_suk');
